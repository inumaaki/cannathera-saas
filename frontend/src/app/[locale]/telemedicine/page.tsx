          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-10 items-center">
            ...
            <div className="max-w-2xl flex flex-col justify-center">
              ...
              <h1 className="text-4xl font-display font-extrabold tracking-tight sm:text-5xl lg:text-[2.75rem] leading-[1.1]">
                Automate data, <br className="hidden sm:block"/>
                <span className="text-mint-bright">scale your platform.</span>
              </h1>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-3xl border border-hairline p-8 shadow-sm flex flex-col hover:shadow-lg transition-all duration-300">
              <div className="w-14 h-14 flex items-center justify-center rounded-2xl bg-pine/5 text-pine mb-6 border border-pine/10">
                <span className="msym text-2xl">developer_mode</span>
              </div>
              <h3 className="text-xl font-display font-extrabold mb-4 text-black">{t("api_title")}</h3>
            ...
            <div className="bg-white rounded-3xl border border-hairline p-8 shadow-sm flex flex-col hover:shadow-lg transition-all duration-300">
              <div className="w-14 h-14 flex items-center justify-center rounded-2xl bg-pine/5 text-pine mb-6 border border-pine/10">
                <span className="msym text-2xl">insights</span>
              </div>
              <h3 className="text-xl font-display font-extrabold mb-4 text-black">{t("integration_title")}</h3>
              <p className="text-base text-black/70 leading-relaxed">
                {t("integration_text")}
              </p>
            </div>
            ...
            <div className="bg-white rounded-3xl border border-hairline p-8 shadow-sm flex flex-col hover:shadow-lg transition-all duration-300">
              <div className="w-14 h-14 flex items-center justify-center rounded-2xl bg-pine/5 text-pine mb-6 border border-pine/10">
                <span className="msym text-2xl">verified_user</span>
              </div>
              <h3 className="text-xl font-display font-extrabold mb-4 text-black">Low Latency</h3>
              <p className="text-base text-black/70 leading-relaxed">
                Built on a robust edge architecture, our endpoints respond in milliseconds to ensure zero lag during consultations.
              </p>
            </div>
