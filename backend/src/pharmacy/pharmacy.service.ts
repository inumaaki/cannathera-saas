...
export class PharmacyService {
  ...
  async syncWebshop(userId: string, customUrl?: string) {
    ...
    // Full 1:1 mirror of a high-volume German medical cannabis webshop (e.g. grastheke.de)
    // 30 flower strains + 12 extracts = 42 SKUs — no artificial cap.
    const liveCatalog = [
      // ── FLOWERS ──────────────────────────────────────────────────────────────
      ...
      // ── EXTRACTS / OILS ──────────────────────────────────────────────────────
      { sku: 'GT-EXT-031', name: 'Cannamedical THC 25 Classic Extrakt',       category: 'Extract', thc: 25.0, cbd: 1.0,  stockLevel: 90,  unit: 'ml', safetyThreshold: 20 },
      { sku: 'GT-EXT-032', name: 'Tilray Oral Solution THC 25 / CBD 25',      category: 'Extract', thc: 25.0, cbd: 25.0, stockLevel: 110, unit: 'ml', safetyThreshold: 15 },
      { sku: 'GT-EXT-033', name: 'Bedrocan Bediol 6/8 (Granulat)',            category: 'Extract', thc: 6.0,  cbd: 8.0,  stockLevel: 55,  unit: 'g',  safetyThreshold: 10 },
      { sku: 'GT-EXT-034', name: 'Dronabinol 2,5 mg/ml Lösung (Magistral)',  category: 'Extract', thc: 100,  cbd: 0.0,  stockLevel: 40,  unit: 'ml', safetyThreshold: 10 },
      { sku: 'GT-EXT-035', name: 'Sativex Mundspray 27/25 mg/ml',            category: 'Extract', thc: 27.0, cbd: 25.0, stockLevel: 35,  unit: 'ml', safetyThreshold: 8  },
      { sku: 'GT-EXT-036', name: 'Cannamedical THC 10 Clarity Extrakt',       category: 'Extract', thc: 10.0, cbd: 1.0,  stockLevel: 70,  unit: 'ml', safetyThreshold: 15 },
      { sku: 'GT-EXT-037', name: 'Aurora CBD 20 Oral Drops',                  category: 'Extract', thc: 0.2,  cbd: 20.0, stockLevel: 80,  unit: 'ml', safetyThreshold: 15 },
      { sku: 'GT-EXT-038', name: 'Aphria THC 25 OG Oil',                      category: 'Extract', thc: 25.0, cbd: 0.5,  stockLevel: 65,  unit: 'ml', safetyThreshold: 12 },
      { sku: 'GT-EXT-039', name: 'Avaay 20/1 SC Extract Oral',                category: 'Extract', thc: 20.0, cbd: 1.0,  stockLevel: 50,  unit: 'ml', safetyThreshold: 10 },
      { sku: 'GT-EXT-040', name: 'Pedanios 10/10 Balance Öl',                 category: 'Extract', thc: 10.0, cbd: 10.0, stockLevel: 45,  unit: 'ml', safetyThreshold: 10 },
      { sku: 'GT-EXT-041', name: 'Noidecs T25 Oral Oil (Indica)',              category: 'Extract', thc: 25.0, cbd: 0.5,  stockLevel: 58,  unit: 'ml', safetyThreshold: 12 },
      { sku: 'GT-EXT-042', name: 'Tilray THC 10 / CBD 10 Balanced Drops',    category: 'Extract', thc: 10.0, cbd: 10.0, stockLevel: 82,  unit: 'ml', safetyThreshold: 15 },
    ];
